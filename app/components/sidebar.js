...
function Sidebar({ onNavigationClick }) {
  const pages = [
    {
      path: "ImportFile",
      name: "Class List Import",
      icon: <ImportFileIcon />,
    },
    { path: "Students", name: "Students", icon: <StudentsIcon /> },
    { path: "GradingForm4", name: "Grading", icon: <GradingIcon /> },
    { path: "displayFile", name: "Display File", icon: <GradingIcon /> },
    { path: "uploadclasslist", name: "Database Upload Test", icon: <GradingIcon /> },
            ...
            return (
              <li key={i}>
                <button
                  ...
                  onClick={() => onNavigationClick(page.path)}
                  htmlFor="my-drawer"
                  type="button"
                >
                  {page.icon}
